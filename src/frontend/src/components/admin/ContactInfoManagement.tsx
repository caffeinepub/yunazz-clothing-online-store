      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="instagram" value={instagram} onChange={(e) => setInstagram(e.target.value)} placeholder="@yunazzclotheshub" required />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              {qrImage && (
                <img src={qrImage.getDirectURL()} alt="Instagram QR" className="w-32 h-32 rounded-lg border object-cover" />
              )}
          ...
          <Button type="submit" disabled={setContactInfo.isPending}>
            {setContactInfo.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
            Save Changes
          </Button>
        </form>
      </CardContent>
